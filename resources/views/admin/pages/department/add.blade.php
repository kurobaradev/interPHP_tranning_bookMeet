...
<div class="container-fluid">
  ...
  @enderror --}}
    ...
    <!-- DataTales Example -->
    <form action="{{route('room-meet.store')}}" method="POST" enctype="multipart/form-data" class="row  d-flex justify-c  ontent-center">
      @csrf
      ...
      <div class="col-6">
        ...
        <div class="form-group">
          <div class="">
            ...
            <input type="number" class="form-control @error('number_join') is-invalid @enderror" value="{{old('number_join')}}" name="number_join">
            @error('number_join')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
          </div>
