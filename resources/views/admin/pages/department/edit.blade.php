...
<div class="container-fluid">
    ...
    <!-- DataTales Example -->
    <form action="{{route('department.update',['id'=>$departments->id])}}" method="POST" enctype="multipart/form-data" class="row d-flex justify-content-center">
        @csrf
        ...
        <div class="col-6">
          <div class="form-group ">
            ...
            <input  type="text" 
                    class="form-control @error('department_number') is-invalid @enderror"
                    placeholder="Tên phòng họp"
                    name="department_number"
                    value="{{$departments->department_number}}"
                    >
            {{-- @error('name')
